...
Texture::Texture(Texture&& other) noexcept
    ...
    // Nullify the source object's handles
...
void Texture::loadFromFile(const std::string& filepath) {
    ...
    copyBufferToImage(stagingBuffer, static_cast<uint32_t>(texWidth), 
...
void Texture::transitionImageLayout(VkFormat format, VkImageLayout oldLayout, 
